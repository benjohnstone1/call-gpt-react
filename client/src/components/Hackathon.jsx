      ...
      <PageHeader size="default">
        ...
        <PageHeaderInPageNavigation>
          <InPageNavigation aria-label={useUID()}>
            <InPageNavigationItem href="#">Model Options</InPageNavigationItem>
            <InPageNavigationItem href="#" currentPage>
              AI Agent Settings
            </InPageNavigationItem>
            <InPageNavigationItem href="#">Advanced Options</InPageNavigationItem>
          </InPageNavigation>
        </PageHeaderInPageNavigation>
      </PageHeader>
    <Box>
        <Form maxWidth="size70">
          <Box display="flex" flexDirection="column">
            ...
            <Paragraph marginBottom="space0">
              This information will be used to create your AI Agent. Give your AI Agent assistant a name and a personality.
            </Paragraph>
          </Box>
          <FormControl>
            <Label htmlFor="author" required>Select an Agent Template</Label>
            <Select id={"template"} value={template} onChange={(e) => handleTemplateChange(e)}>
          ...
          <FormControl>
            <Label htmlFor="aiPrompt" required>Agent Persona</Label>
            <TextArea id="systemContext" value={systemContext} onChange={()=>{}} aria-describedby="message_help_text" name="aiPrompt" resize="vertical" maxRows={15} required />
            <HelpText id="aiPrompt_help_text">Describe your agent in detail</HelpText>
          </FormControl>
          <FormControl>
            <Label htmlFor="languageSettings" required>Languge Settings</Label>
            <Input type="text" id="languageSettings" value={languageSettings} onChange={(e) => setLanguageSettings(e.target.value)} name="input3" />
          </FormControl>
          <FormControl>
            <Label htmlFor="initialGreeting" required>Initial Agent Greeting</Label>
            <TextArea id="initialGreeting" name="initialGreeting" value={initialGreeting} onChange={(e) => setInitialGreeting(e.target.value)} maxRows={5} required/>
          </FormControl>
          <FormControl>
